<?php
			...
			$num = 0;
			$sql = "SELECT * FROM products p JOIN brand b WHERE p.title = 'Angel Backpack' && p.brand = b.id";
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-footer">
						...
						<button class="btn btn-warning" method="post" value="<?= $product['title']; ?>" type="submit"><span class="glyphicon-shopping-cart"></span>Add to Cart</button>
			</div>
		</div>
	</div>
</div>
