<?php
			...
			$num = 0;
			$sql = "SELECT * FROM products p JOIN brand b WHERE p.title = 'T-shirt and Short set 4' && p.brand = b.id";
			$featured = $mysqli-> query($sql);
			$product = mysqli_fetch_assoc($featured);
			$num += 1;
?>
<div class="modal fade details-27" id="details-27" tableindex="-1"  role="dialog" aria-labelledby="details-27" aria-hidden="true">
